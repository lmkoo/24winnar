  ...
  <div class="tilt">
    <div class="tiltin box" style="display:flex;flex-direction:column;gap:20px;align-items:center;text-align:center;">
      <div style="display:flex;align-items:center;gap:20px;">
          <img src="${pic}" alt="Picture" style="width:150px;height:150px;border-radius:50%;border:3px solid rgba(255,0,0,0.8);box-shadow:0 0 12px rgba(255,0,0,0.7);" />
          <div style="font-size:2.5rem;font-weight:700;color:#ff6666;text-shadow:0 0 10px #ff0000;">
          ${uname}
        </div>
      </div>
...
const about = `hola guys im tungtungcat and im cool also i made holdable templates go public and i like c# btw im in kawaii which is a cool w group`;

const projects = `
<div style="font-size:1.5rem;color:#ff6666;text-shadow:0 0 10px #ff0000;">
